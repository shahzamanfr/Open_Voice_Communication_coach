...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-full px-4 lg:px-8 mx-auto max-w-7xl">
      <div className={`flex items-center justify-between py-5 border-b sticky top-0 z-30 backdrop-blur-md transition-colors duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] ${
        theme === 'dark' 
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href="#image-describe"
            className={`rounded-full border px-4 py-2 text-xs sm:text-sm font-semibold hover:opacity-90 transition-colors duration-200 ${
              theme === 'dark' 
                ? 'border-gray-600 bg-black text-white' 
                : 'border-gray-300 bg-white text-black'
            }`}
