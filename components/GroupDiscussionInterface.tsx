...
import { getGroupDiscussionResponse, getGroupDiscussionEvaluation } from '../services/geminiService';
...
const GroupDiscussionInterface: React.FC<GroupDiscussionInterfaceProps> = ({ onBack, ai }) => {
  const [currentStep, setCurrentStep] = useState<'topic' | 'discussing' | 'evaluation'>('topic');
  ...
  useEffect(() => {
    if (currentStep === 'discussing' && activeAgents.length > 0 && !isAIActive && loadingState === LoadingState.Idle) {
  ...
  }, [currentStep, activeAgents.length, isAIActive, loadingState, discussionTopic, messages]);
  ...
  const handleTopicSubmit = async () => {
    ...
    try {
      ...
      const response = await getGroupDiscussionResponse(ai, discussionTopic, '', 0, true, selectedAgents);
      ...
      setError("An error occurred while starting the discussion. Please try again.");
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setError("An error occurred while getting the AI's response. Please try again.");
      setLoadingState(LoadingState.Error);
    }
  };
      ...
      <div className="border-b border-gray-800 p-6">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-semibold text-white">Group Discussion Coach</h1>
            <p className="text-sm text-gray-400">Practice with AI agents in realistic group discussions</p>
          </div>
          ...
          <div className="space-y-6">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto leading-relaxed">
                Enter a topic for group discussion. You'll join 3 AI agents with different personalities 
                in a realistic, dynamic conversation that will challenge and develop your discussion skills.
              </p>
            </div>
            ...
            <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
              ...
              <textarea
                ...
                className="w-full h-32 p-4 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-white/50 resize-none transition-colors duration-200"
                disabled={isLoading}
              />
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
              <div className="flex items-center mb-4">
                <div className={`w-2 h-2 rounded-full mr-3 ${isAIActive ? 'bg-blue-400 animate-pulse' : 'bg-green-400 animate-pulse'}`}></div>
                <h3 className="text-xl font-semibold text-white">
                  Live Group Discussion
                  {isAIActive && <span className="text-sm text-blue-400 ml-2">(AI agents discussing...)</span>}
                </h3>
              </div>
              <h4 className="text-lg font-medium text-gray-300 mb-4">{discussionTopic}</h4>
                  ...
                  <div key={index} className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50">
                    <div className="flex items-center mb-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">{agent.personality}</p>
                      </div>
                    </div>
                      ...
                      {message.type === 'agent' && (
                        <div className="flex items-center mb-2">
                          <span className="text-lg mr-2">
                            {activeAgents.find(a => a.name === message.agentName)?.avatar}
                          </span>
                    ...
                    <div className="bg-gray-700 text-gray-100 px-4 py-3 rounded-lg">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm">
                          {isAIActive ? 'AI agents are discussing...' : 'AI agents are thinking...'}
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex space-x-3">
                <div className="flex-1">
                  <input
                    ...
                    onKeyPress={(e) => e.key === 'Enter' && !isLoading && !isAIActive && currentMessage.trim() && handleSendMessage()}
                  />
                </div>
        ...
        {currentStep === 'evaluation' && finalEvaluation && (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto leading-relaxed">
                Here's your comprehensive group discussion performance. The AI has evaluated your 
                participation, communication skills, and contribution quality throughout the discussion.
              </p>
            </div>
            ...
            <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-semibold text-white">Overall Group Discussion Score</h3>
                <div className="text-3xl font-bold text-white">{finalEvaluation.overall_score}/100</div>
              </div>
            ...
            {/* Category Scores */}
            <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
              <h3 className="text-xl font-semibold text-white mb-4">Group Discussion Skills Analysis</h3>
                ...
                {Object.entries(finalEvaluation.category_scores).map(([category, score]) => {
                  ...
                  return (
                    <div key={category} className="text-center">
                      <div className="text-2xl font-bold text-white mb-1">{score}/20</div>
                      <div className="text-sm text-gray-400">{categoryNames[category] || category}</div>
            ...
            {/* Final Feedback */}
            <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
              <h3 className="text-xl font-semibold text-white mb-4">Group Discussion Assessment</h3>
              <p className="text-gray-300 leading-relaxed mb-4">{finalEvaluation.feedback}</p>
              
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-white mb-2">Discussion Strengths:</h4>
            ...
            {/* Improvement Tips */}
            <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
              <h3 className="text-xl font-semibold text-white mb-4">Group Discussion Improvement Tips</h3>
            ...
            {finalEvaluation.communicationBehavior && (
              <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700">
                <h3 className="text-xl font-semibold text-white mb-4">Your Discussion Style</h3>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-medium text-white mb-2">Discussion Profile:</h4>
